...
local function Brackets()
    ...
    rbox(0, scrw * 0.160, scrh * 0.0370, math.ceil( scrw * 0.11), scrh * 0.002, _RDS:Color("WHITE", 255)) // LEFT(LINE)
    rbox(0, scrw * 0.725, scrh * 0.0370, math.ceil( scrw * 0.11), scrh * 0.002, _RDS:Color("WHITE", 255))  // RIGHT(LINE)

...
net.Receive( "ARM_LOCKER_Weapon_Menu", function( len, ply )
	...
	LOCKER_GUI_Frame.Paint = function( self, w, h )
	...
	GUI_Armory_Exit.Paint = function( self, w, h )
		draw.RoundedBox( 8, 1, 1, w, h, color_transparent )
	end
	...
	Weapon1Panel.Paint = function( self, w, h )
		draw.RoundedBox( 8, 1, 1, w, h, color_transparent )	
	end
	...
	GUI_Weapon1Take.Paint = function( self, w, h )
		if GUI_Weapon1Take:IsHovered() then
			draw.RoundedBoxEx( 8, 0, 0, w, h, col_light_green, false, false, false, false )
		else
			draw.RoundedBoxEx( 8, 0, 0, w, h, col_green, false, false, false, false )
		end

		draw.SimpleText( "Entnehmen", "ARMORY_UIFontButton", w / 2, h / 2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	end
	...
	Weapon2Panel.Paint = function( self, w, h )
		draw.RoundedBox( 8, 1, 1, w, h, color_transparent )	
	end
	...
	GUI_Weapon2Take.Paint = function( self, w, h )
	...
	Weapon3Panel.Paint = function( self, w, h )
		draw.RoundedBox( 8, 1, 1, w, h, color_transparent )	
	end
	...
	GUI_Weapon3Take.Paint = function( self, w, h )

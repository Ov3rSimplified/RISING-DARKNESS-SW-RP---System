...
function DrawBurStamina()
	...
	--	surface.SetMaterial( Mat )
	--	surface.SetDrawColor(38,255,0,BaseFade * BasePercent)
		draw.RoundedBox(0, scrw * .78 + scrw * wo, scrh * .015 + scrh * ho,scrw * .2*Percent,scrh * .01,Color(255,0,0,BaseFade * BasePercent))

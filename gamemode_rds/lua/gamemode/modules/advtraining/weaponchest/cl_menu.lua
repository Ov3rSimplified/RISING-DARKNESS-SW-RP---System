...
timer.Simple(0.5, function()
	...
	info:SetText( "" )
		...
		info.Paint = function(self,w,h)
			...
			draw.SimpleText("Primär ["..tostring(primweap .. "/" .. _RDS.Admin.IConfig["Weaponsystem"].Core.MaxPrimary ).."]  || Sekundär ["..tostring(secweap .. "/" .. _RDS.Admin.IConfig["Weaponsystem"].Core.MaxSecondary).."]", "RDS.AdvTrain.informations", self:GetWide()/2, self:GetTall()/2, _RDS:Color("WHITE", 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		end
